...
console.log(`tyrannosaurus weighed ${trex.weight}`);

// What was the diet of a velociraptor?
console.log(`velociraptor was a hardcore paleo hipster his diet was ${raptor.diet}`);

// How long was a stegosaurus?
console.log(`teeth to tail spikes, stegosaurus was ${stego.length} long`);

// What time period did tyrannosaurus live in?
console.log(`if marty mcfly wants to mess with rex, set car to the ${trex.period} era`);
...
zooAnimals = [
  {                                                     //each object is an element, I'm refering to as "animal"
...
//"name" .animal_name  + "Scientific" .scientifi_name '
*/
const animalNames = [];

zooAnimals.forEach(function (animal) {               //see comment at line 130
...
//1:24     !!!i put )   after animal on line 155, should have been after my cb function on line 157 .... !!!
...
//const lowerCase = [];             //just zooAnimals.animal_name
const lowerCase = zooAnimals.map(animal=>animal.animal_name.toLowerCase());   //was using array name instead of element name after arrow function

// const lowerNames= zooAnimals.map(function  {
//   lowerCase.push(zooAnimals.animal_name.toLowerCase())
// })

//NOT SUPER CLEAR ON ELEMENTS AND CALLBACKS IN ADVANCE ARRAYS
...
//1:55   GOT IT TO WORK WITH NOTES, NEED TO UNDERSTAND MORE
